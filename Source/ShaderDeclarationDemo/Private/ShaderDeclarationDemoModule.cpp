...
void FShaderDeclarationDemoModule::StartupModule()
{
	...
	FString PluginShaderDir = FPaths::Combine(IPluginManager::Get().FindPlugin(TEXT("UnrealShaderTemplate"))->GetBaseDir(), TEXT("Shaders"));
...
void FShaderDeclarationDemoModule::PostResolveSceneColor_RenderThread(FRDGBuilder& GraphBuilder, const FSceneTextures& SceneTextures)
{
